...
{
	public const byte FLY_COUNT_LIMIT = 50;
	...
	void Start()
	{
		...
		//cameraTransform = GameObject.FindGameObjectWithTag("FliesTrans").transform;   // use the transform attached to the [CameraRig]
		Create ();
	}
	public void Create()
	{
